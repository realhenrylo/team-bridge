---
description: Team bridge — create | join <code> | leave | on | off | dnd | visible | invisible | status
...
The first invocation of this skill starts this session's team inbox monitor. It is off at session startup; after resuming a joined conversation, `/team on` enables idle notifications. New/forked conversations must create or join a room explicitly.
